...
CUDA_VISIBLE_DEVICES=1,2,3 uv run accelerate launch --config_file accelerate_config.yaml --main_process_port $port \
...
--max_steps=80000 --gradient_accumulation_steps=22 --max_packed_inp_len=4096 \
